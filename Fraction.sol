...
library Fraction {
    ...
    int256 private constant sqrtNum = 1 << 120;
    int256 private constant shl = 80;
    uint8 private constant PRECISION = 32; // fractional bits
    uint256 private constant FIXED_ONE = uint256(1) << PRECISION; // 0x100000000
    uint256 private constant FIXED_TWO = uint256(2) << PRECISION; // 0x200000000
    uint256 private constant MAX_VAL = uint256(1) << (256 - PRECISION); // 0x0000000100000000000000000000000000000000000000000000000000000000
     ...
     */
    function abs(fractionNumber memory a)
        internal
        pure
        returns (fractionNumber memory)
    {
        if (a.numerator < 0) {
     ...
     */
    function invert(fractionNumber memory a)
        internal
        pure
        returns (fractionNumber memory)
    {
     ...
     */
    function sqrt(fractionNumber memory a)
        internal
        pure
        returns (fractionNumber memory)
    {
        require(
            a.numerator >= 0 && a.denominator >= 0,
            "Sqrt must input a positive value"
        );
        return
            fractionNumber(
                int256(sqrt(uint256(a.numerator))),
                int256(sqrt(uint256(a.denominator)))
            );
    }
     ...
     */
    function div(fractionNumber memory a, fractionNumber memory b)
        internal
        pure
        returns (fractionNumber memory)
    {
     ...
     */
    function mul(fractionNumber memory a, fractionNumber memory b)
        internal
        pure
        returns (fractionNumber memory)
    {
     ...
     */
    function add(fractionNumber memory a, fractionNumber memory b)
        internal
        pure
        returns (fractionNumber memory)
    {
     ...
     */
    function sub(fractionNumber memory a, fractionNumber memory b)
        internal
        pure
        returns (fractionNumber memory)
    {
    ...
    function zoomOut(fractionNumber memory a, int256 rate)
        internal
        pure
        returns (fractionNumber memory)
    {
    ...
    function zoomin(fractionNumber memory a, int256 rate)
        internal
        pure
        returns (fractionNumber memory)
    {
        return
            safeFractionNumber(
                fractionNumber(a.numerator * rate, a.denominator * rate)
            );
    }
     ...
     */
    function ln(fractionNumber memory a)
        internal
        pure
        returns (fractionNumber memory)
    {
    ...
    function safeFractionNumber(fractionNumber memory a)
        internal
        pure
        returns (fractionNumber memory)
    {
    ...
    function fractionDiv(fractionNumber memory a, fractionNumber memory b)
        internal
        pure
        returns (fractionNumber memory)
    {
    ...
    function fractionMul(fractionNumber memory a, fractionNumber memory b)
        internal
        pure
        returns (fractionNumber memory)
    {
    ...
    function fractionAdd(fractionNumber memory a, fractionNumber memory b)
        internal
        pure
        returns (fractionNumber memory)
    {
    ...
    function fractionSub(fractionNumber memory a, fractionNumber memory b)
        internal
        pure
        returns (fractionNumber memory)
    {
     ...
     */
    function normsDist(fractionNumber memory xNum)
        internal
        pure
        returns (fractionNumber memory)
    {
    ...
    function pow(fractionNumber memory _x, fractionNumber memory _y)
        internal
        pure
        returns (fractionNumber memory)
    {
     ...
     */
    function exp(fractionNumber memory _x)
        internal
        pure
        returns (fractionNumber memory)
    {
     ...
     */
    function fractionExp_sub(fractionNumber memory _x)
        internal
        pure
        returns (fractionNumber memory)
    {
        ...
        if (intValue > 0x386bfdba29) {
            fractionNumber memory _x1 =
                fractionNumber(_x.numerator / 2, _x.denominator);
            fractionNumber memory _x2 =
                fractionNumber(_x.numerator - _x1.numerator, _x.denominator);
            _x1 = fractionExp_sub(_x1);
            _x2 = fractionExp_sub(_x2);
            return mul(_x1, _x2);
        } else {
            return
                fractionNumber(int256(fixedExp(intValue)), int256(FIXED_ONE));
        }
    }
